...
window.openKYC = async function(withdrawalId) {
    ...
    // KYC bot username'i - BURAYA KENDİ KYC BOTUNUZU YAZIN
    const KYC_BOT_USERNAME = "YourKYCBot"; // ⚠️ DEĞİŞTİRİN!
    
    // Withdrawal ID'yi bot'a parametre olarak gönder
    const kycUrl = `https://t.me/${KYC_BOT_USERNAME}?start=kyc_${state.wallet}_${withdrawalId}`;
