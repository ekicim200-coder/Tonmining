...
function setupEventListeners() {
    ...
    // Copy ve Share butonları kaldırıldı
...
// --- REFERRAL POPUP --- (DEVRE DIŞI)
function checkReferralPopup() {
    // Popup kaldırıldı - referral sistemi arka planda çalışıyor
    let refCode = null;
    ...
    // Popup göstermeden direkt kaydet
...
function updateReferralUI() {
    // Input'lar kaldırıldı, sadece istatistikler gösterilecek
