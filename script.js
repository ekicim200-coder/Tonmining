...
function renderInv() {
    ...
    state.inv.slice().reverse().forEach(i => {
        ...
        if (isFree) {
            badgeStyle = 'background:rgba(239,68,68,0.2); color:var(--danger); border:1px solid var(--danger); padding:4px 8px; border-radius:6px;';
        } else if (isBonus) {
            badgeStyle = 'background:rgba(255,215,0,0.2); color:#FFD700; border:1px solid #FFD700; padding:4px 8px; border-radius:6px;';
        } else {
        ...
        <div class="card-item">
            ...
            <div class="ci-action" style="font-weight:bold; font-size:0.8rem;">
